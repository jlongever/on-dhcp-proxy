...
function messageHandlerFactory(
    ...
    MessageHandler.prototype.activeTaskExists = function (target) {
    ...
    MessageHandler.prototype.getBootProfile = function (nodeId, options) {
